...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/whoahhaha-3992)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/whoahhaha-3992
```

A live public deployment of this template is available at [https://whoahhaha-3992.templates.workers.dev](https://whoahhaha-3992.templates.workers.dev)
